        ...
        if(typeof(this.props.menu.value)!=="object"){
            return (
                <li className="nav-item" key={this.props.menu.value}>
                    <a className="nav-link" href="#" onClick={this.props.changePage}>{this.props.menu.value}</a>
                </li>
            );
        }
                ...
                <li className="nav-item" key={keys}>
                    ...
                    <div style={this.state.style} className="collapse" id={"#submenu".concat(this.props.menu.id)} aria-expanded="false">
                        <ul className="flex-column pl-2 nav">
                            {this.props.menu.value[keys[0]].map(subitem => <li className="nav-item" key={subitem}><a className="nav-link" href="#" onClick={this.props.changePage}>{subitem}</a></li>)}
                        </ul>
                    </div>
                </li>
            );
